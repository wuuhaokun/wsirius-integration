...
import com.wsirius.rbac.security.domain.entity.unionkey.RolePermissionKey;
import com.wsirius.rbac.security.domain.entity.unionkey.UserRoleKey;
...
public class RabcUserUtil {
    ...
    private User createUser(RegisterRequest registerRequest, boolean isAdmin) {
        User user = new User();
    ...
    public Boolean registerUser(RegisterRequest registerRequest) {
        try {
            ...
            throw new SecurityException(String.valueOf(WStatus.TOKEN_PARSE_ERROR));
        }
    }

    private void createRabcUser() {
        ...
        Permission monitorOnlineBtnQueryPerm = createPermission("/**/api/v1/monitor/online/user", "在线用户页面-查询", 2, "btn:monitor:online:query", "GET", 1, monitorOnlinePagePerm.getId());
        Permission monitorOnlineBtnKickoutPerm = createPermission("/**/api/v1/monitor/online/user/kickout", "在线用户页面-踢出", 2, "btn:monitor:online:kickout", "DELETE", 2, monitorOnlinePagePerm.getId());
    ...
    private void createRolePermissionRelation(Long roleId, Long permissionId) {
        ...
        rolePermissionService.insert(adminPage);
    }
